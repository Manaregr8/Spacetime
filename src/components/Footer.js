          ...
          <div className={styles.col}>
            ...
            <ul className={styles.contactList}>
              <li className={styles.contactItem}>
                ...
                <a href="tel:+919818450490" className={styles.contactLink}>+91 98184 50490</a> <a href="tel:+919810474703" className={styles.contactLink}>098184 50490</a>
              </li>
              <li className={styles.contactItem}>
                <span className={styles.contactIcon}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="mailto:amit@myspacetime.in" className={styles.contactLink}>amit@myspacetime.in</a>
              </li>
              <li className={styles.contactItem}>
                <span className={styles.contactIcon}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

    ...
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.subtext}>
          Curated sanctuaries for those who build. Hospitality-first. Design
          that elevates. An ecosystem expanding with intention.
        </p>
        <button className={styles.ctaWrapper} onClick={openModal}>
          <span className={styles.ctaMain}>Claim free day pass</span>
          <span className={styles.ctaSub}>No commitment, simply an invitation</span>
        </button>
      </div>

      {/* Company logos marquee */}
      <div className={styles.logosSection}>
        <p className={styles.logosLabel}>180+ companies scaling with us</p>

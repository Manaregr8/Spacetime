        ...
        <div className={styles.container}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>Limit the number of guests you bring into the Space. For guest access on weekends, 24 hours notice is required in writing to <a href="mailto:akash@myspacetime.in" className={styles.link}>akash@myspacetime.in</a> and is subject to approval from the Management.</li>
